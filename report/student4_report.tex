...
The repository contains the complete ablation driver
(\texttt{run\_ablation.py}), the visualization pipeline
(\texttt{student4\_visualizations.py}), all 12 raw experiment
outputs, and the LaTeX source of this report.
